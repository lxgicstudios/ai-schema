...
![npm](https://img.shields.io/npm/v/ai-schema)
![Node.js](https://img.shields.io/badge/node-%3E%3D16.0.0-brightgreen)
![License](https://img.shields.io/npm/l/ai-schema)
![TypeScript](https://img.shields.io/badge/typescript-%3E%3D4.0-blue)

# JSON schema generation and validation utilities

Schema validation generator. Creates JSON Schema and TypeScript interfaces from data.
## Usage
...
[![npm version](https://badge.fury.io/js/ai-schema.svg)](https://badge.fury.io/js/ai-schema)
